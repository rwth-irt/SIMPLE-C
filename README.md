...
8. **Convergence:** The tool can be stopped manually by stopping on visual feedback in the web-GUI or the ICP refinement stage can be activated and it fitness score can be used to terminate the calibration process.
